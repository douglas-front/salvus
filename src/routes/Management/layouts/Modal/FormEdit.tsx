  ...
  export default function FormEdit({ id, name }: Props) {
    ...
    const [editProduct, setEditProduct] = useState<IProduct>({ productName: '', description: '', price: 0 , id});
    ...
    const handleSubmit = async (e: FormEvent) => {
      ...
      try {
        ...
        const response = await fetch(`https://api-salvus.vercel.app/product/update/${id}`, {
          method: "PUT",
          headers: {
